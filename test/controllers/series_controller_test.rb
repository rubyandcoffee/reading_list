...
class SeriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create series" do
    assert_difference("Series.count") do
      post series_index_url, params: { series: { author_id: @series.author_id, name: @series.name } }
    end
  ...
  test "should update series" do
    patch series_url(@series), params: { series: { author_id: @series.author_id, name: @series.name } }
